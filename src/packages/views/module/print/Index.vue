        ...
        <a-row>
            <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <a-space :size="8" style="margin-bottom: 10px">
                    <a-button type="primary" @click="handleJsonPrint(Object.keys(someJSONData[0]))"
                        >JSON数据打印</a-button
                    >
                    <a-button type="primary" @click="handleJsonPrint(['name', 'email'])"
                        >JSON数据打印指定字段name，email
                    </a-button>
                </a-space>
                <code>
        ...
        <a-row>
            <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                ...
                <div class="dom" id="htmlPrint">
                    ...
                    <h5>打印次级标题</h5>
                    <p>
                        正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文正文
                    </p>
                </div>
            </a-col>
        </a-row>
