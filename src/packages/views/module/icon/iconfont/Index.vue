...
export default defineComponent({
    ...
    setup() {
        ...
        const handleToClipboard = (str: string) => {
            toClipboard(`<${toHump(str)}/>`)
                .then((res: any) => {
                    let html = []
                    html.push(
                        h('i', { class: str, style: { marginRight: '10px', color: '#52c41a' } }),
                    )
