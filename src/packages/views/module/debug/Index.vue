<template>
    <bag-view>
        <a-table :columns="columns" :data-source="data" bordered>
            ...
            <template #footer>
                官方推荐可以使用错误追踪服务
                <a href="https://sentry.io/for/vue/" target="_blank">Sentry</a>和
                <a target="_blank" href="https://docs.bugsnag.com/platforms/javascript/vue/"
                    >Bugsnag </a
                >使用此选项提供官方集成
            </template>
        </a-table>
...
const data = [
    {
        ...
        stack:
            'TypeError: _ctx.handleSkip is not a function\n' +
    ...
    {
        browserInfo:
            'mozilla/5.0 (windows nt 6.1; wow64) applewebkit/537.36 (khtml, like gecko) chrome/86.0.4240.198 safari/537.36 qihu 360ee/13.0.2256.0',
    ...
    },
    {
        ...
        location: 'http://192.168.1.103:8290/lib.html#/module/debug',
        message:
            'Invalid prop: type check failed for prop "record". Expected Object, got Number with value 8. \n',
        stack: '',
        create_time: '2021-12-26 18:27:45',
    },
]
