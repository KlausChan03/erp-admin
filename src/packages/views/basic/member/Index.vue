<template>
    <bag-form-table>
        <div class="table-action">
            <div class="table-action-btn">
                <a-space :size="20">
                    ...
                    <a-button type="primary" danger size="middle" @click="tableCurd.deletes.submit"
                        >删除</a-button
                    >
                </a-space>
            </div>
        ...
        <a-table
            ...
            size="middle"
            :bordered="true"
            :data-source="tableCurd.tableData"
        ...
        >
            ...
            <template #action="{ record }">
                <a-space>
                    <a-button type="primary" size="small" @click="pasData.handle({ record })"
                        >密码</a-button
                    >
                    <a-button type="primary" size="small" @click="tableCurd.edit.change(record)"
                        >编辑</a-button
                    >
                    <a-popconfirm
    ...
    <bag-modal
        v-model:visible="tableCurd.create.visible"
        title="新增"
        width="85%"
    ...
    <bag-modal
        v-model:visible="tableCurd.edit.visible"
        title="编辑"
        width="85%"
    ...
    <bag-modal
        v-model:visible="rolesData.visible"
        :title="rolesData.title"
        width="85%"
        @ok="visibleRoles = false"
    >
        <a-table
            rowKey="id"
            :pagination="false"
