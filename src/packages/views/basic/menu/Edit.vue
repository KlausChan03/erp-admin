            ...
            <a-row>
                ...
                <a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                    <a-form-item label="网络组件" name="httpFilePath">
                        <a-input
                            v-model:value="formState.httpFilePath"
                ...
                <a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                    <a-form-item label="内嵌iframe" name="iframePath">
                        <a-input
                            v-model:value="formState.iframePath"
                ...
                <a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                    <a-form-item label="外部链接" name="httpViewPath">
                        <a-input
                            v-model:value="formState.httpViewPath"
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const rules = {
            ...
            icon: [{ required: false, message: 'icon为必填项', trigger: 'blur' }],
            filePath: [{ validator: filePathRouter, trigger: 'blur' }],
            httpFilePath: [{ validator: validatHttpFilePath, trigger: 'blur' }],
            iframePath: [{ validator: validatHttpFilePath, trigger: 'blur' }],
            httpViewPath: [{ validator: validatHttpFilePath, trigger: 'blur' }],
        }
        ...
        watch(
            ...
            (newVal, oldVal) => {
                treeData.value = filterData(
                    { key: 'id', value: props.id, node: 'children' },
                    toTree(props.treeData),
                )
            },
            { immediate: true },
        )
