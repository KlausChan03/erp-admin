export default [
    ...
    },
    {
        ...
        name: 'basic-member',
        meta: { title: '用户管理' },
        component: () => import('@/packages/views/basic/member/Index.vue'),
    },
    // {
    //     path: '/basic/role',
    //     name: 'basic-role',
    //     meta: { title: '角色管理' },
    //     component: () => import('@/packages/views/basic/role/Index.vue'),
    // },
    // {
    //     path: '/basic/store',
    //     name: 'basic-store',
    //     meta: { title: '门店信息管理' },
    //     component: () => import('@/packages/views/basic/store/Index.vue'),
    // },
    // {
    //     path: '/basic/account',
    //     name: 'basic-account',
    //     meta: { title: '账户信息管理' },
    //     component: () => import('@/packages/views/basic/account/Index.vue'),
    // },
    // {
    //     path: '/basic/provider',
    //     name: 'basic-provider',
    //     meta: { title: '供应商信息管理' },
    //     component: () => import('@/packages/views/basic/provider/Index.vue'),
    // },
    // {
    //     path: '/basic/investor',
    //     name: 'basic-investor',
    //     meta: { title: '投资人信息管理' },
    //     component: () => import('@/packages/views/basic/investor/Index.vue'),
    // },
    // {
    //     path: '/basic/goods',
    //     name: 'basic-goods',
    //     meta: { title: '物品档案管理' },
    //     component: () => import('@/packages/views/basic/goods/Index.vue'),
    // },
    {
        path: '/finance/payment',
        name: 'finance-payment',
        meta: { title: '付款单' },
        component: () => import('@/packages/views/finance/payment/Index.vue'),
    },
    {
        path: '/finance/receipt',
        name: 'finance-receipt',
        meta: { title: '收款单' },
        component: () => import('@/packages/views/finance/receipt/Index.vue'),
    },
    {
        path: '/sys/menu',
        name: 'sys-menu',
